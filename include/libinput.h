...
extern  const struct river_libinput_config_v1_listener river_libinput_config_listener;
extern const struct river_libinput_device_v1_listener river_libinput_device_listener;
