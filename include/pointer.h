...
extern const struct river_pointer_binding_v1_listener river_pointer_binding_listener;
...
void pointer_binding_create(struct Seat *seat, uint32_t mods, uint32_t button, enum Action action);
